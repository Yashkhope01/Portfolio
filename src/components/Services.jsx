  ...
  const services = [
    {
      ...
      title: 'HTML Dev',
      description:
        'Developed responsive websites using HTML, CSS, and JavaScript, ensuring cross-browser compatibility and mobile optimization. Collaborated with designers to implement UI/UX designs.',
    },
    {
  ...
  return (
    <section id="services" className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="container mx-auto relative z-20">
        ...
        >
          <span className="text-gray-600 dark:text-gray-400 text-sm font-medium">What have I done so far</span>
